    ...
    lessons: [
      {
        ...
        vocabulary: [
          ...
          { french: "comment vas-tu ?", phonetic: "kifash ntiya ?", arabic: "كِفَاش نْتِيَّا ؟", notes: "Ou 'labas 3lik ?'" },
          ...
          { french: "resp: et toi ?", phonetic: "w-ntiya ?", arabic: "وَنْتِيَّا ؟", notes: "Pour retourner la question" },
...
Ne traduisez pas littéralement « je suis X ans » !`,
      ...
      },
      {
        ...
        phrases: [
          ...
          { french: "Vous parlez français ?", phonetic: "katkellmu b-fransawiya ?", arabic: "كَتْكَلِّمُو بِالفِرَنْسَاوِيَّة ؟", context: "Demander si quelqu'un parle français" },
...
- Les billets : 20, 50, 100, 200 Dh`,
      ...
      },
      {
        ...
        phrases: [
          ...
          { french: "Le vendredi, c'est fermé", phonetic: "l-juma mashghul", arabic: "الجُمُعَة مَشْغُول", context: "Information pratique" },
    ...
    lessons: [
      {
        ...
        vocabulary: [
          ...
          { french: "bébé", phonetic: "sghir", arabic: "صْغِيرٌ", notes: "Litt. 'petit'" },
        ],
        phrases: [
...
- dyalkum (ديالكم) = votre`,
      ...
      },
      {
        ...
        phrases: [
          ...
          { french: "Ma grand-mère habite à Fès", phonetic: "jda dyali ksnet f fas", arabic: "جَدَّة دْيَالِي كَنْسَنْت فِ فَاس", context: "Localiser un membre de la famille" },
          ...
          { french: "Mon oncle est commerçant", phonetic: "3ammi tojjer", arabic: "عَمِّي تَاجِر", context: "Parler du métier d'un parent" },
...
- khwal (خْوَال) = oncles maternels`,
      ...
      },
      {
        ...
        duration: "7 min",
        vocabulary: [
          { french: "grand / grand(e)", phonetic: "kbir", arabic: "كَبِيرٌ", notes: "Pour l'âge ou la taille" },
          { french: "petit / petit(e)", phonetic: "sghir", arabic: "صْغِيرٌ", notes: "Pour l'âge ou la taille" },
          { french: "gentil(le)", phonetic: "mzyan / mzyana", arabic: "مْزْيَان / مْزْيَانَة", notes: "Masc. et fém." },
          { french: "travailleur / travailleuse", phonetic: "kaddab", arabic: "كَدَّابٌ", notes: "Litt. 'celui qui peine'" },
          { french: "âgé(e)", phonetic: "3ajuz", arabic: "عَجُوزٌ", notes: "Pour les personnes âgées" },
          ...
          { french: "célibataire", phonetic: "3zab / ma-mzawej-ch", arabic: "عَزَاب / مَا مَزَوَّجْش", notes: "En darija, on dit souvent 'ma-mzawej-ch' (non marié)" },
          { french: "heureux / heureuse", phonetic: "farhan / farhana", arabic: "فَرْحَان / فَرْحَانَة" },
          { french: "ressemblant (comme)", phonetic: "shbih", arabic: "شْبِيهٌ", notes: "Ressemble à quelqu'un" },
        ],
        phrases: [
...
- **Shwiya** = un peu (شوية)`,
      ...
      },
      {
        ...
        vocabulary: [
          ...
          { french: "cher / coûteux", phonetic: "ghali", arabic: "غَالِي", notes: "Le premier mot à apprendre pour marchander" },
          { french: "pas cher / bon marché", phonetic: "rakhis", arabic: "رَخِيصٌ", notes: "Prix raisonnable" },
          { french: "marchander / négocier", phonetic: "msawer", arabic: "مُسَاوِر", notes: "Art essentiel au Maroc !" },
...
- **L-** (لِ) = pour/à : l-dar (à la maison)`,
        ...
        quiz: [
          ...
          { question: "Que signifie 'msawer' ?", options: ["Acheter", "Marchander", "Vendre", "Regarder"], correctIndex: 1 },
      ...
      },
      {
        ...
        vocabulary: [
          ...
          { french: "délicieux", phonetic: "bnin", arabic: "بَنِينٌ", notes: "Mot très utilisé pour compliment" },
...
- **Tanjiya** (طَنْجِيَّة) : tajine de Marrakech à la viande et aux œufs`,
      ...
      },
      {
        ...
        vocabulary: [
          ...
          { french: "jus d'orange", phonetic: "3asir limun", arabic: "عَصِير لَيْمُون", notes: "Les oranges marocaines sont fameuses" },
          ...
          { french: "froid", phonetic: "brdan", arabic: "بَرْدَانٌ", notes: "Pour une boisson fraîche" },
          { french: "chaud", phonetic: "skhun", arabic: "سُخُونٌ", notes: "Pour une boisson chaude" },
        ],
        phrases: [
          ...
          { french: "Un jus d'orange frais", phonetic: "3asir limun jdid", arabic: "عَصِير لَيْمُون جَدِيد", context: "Commander un jus" },
...
- **Kifash baghih** = comment le veux-tu ?`,
        ...
        quiz: [
          ...
          { question: "Comment dit-on 'un verre d'eau' ?", options: ["kass d-l-ma", "3asir limun", "atay wahed", "qahwa sda"], correctIndex: 0 },
          { question: "Comment dit-on 'jus d'orange' ?", options: ["atay limun", "3asir limun", "l-7lib limun", "sharba limun"], correctIndex: 1 },
    ...
    lessons: [
      {
        ...
        vocabulary: [
          ...
          { french: "le quartier", phonetic: "l-7ay / d-shra", arabic: "الحَيُّ / دِشْرَة", notes: "'l-7ay' = le quartier, 'd-shra' = le voisinage" },
        ],
        phrases: [
    ...
    lessons: [
      {
        ...
        vocabulary: [
          ...
          { french: "sortir", phonetic: "n-khrej", arabic: "نَخْرُج", notes: "Sortir de la maison" },
        ...
        phrases: [
          ...
          { french: "Je dois partir", phonetic: "khassni n-khrej", arabic: "خَاصْنِي نَخْرُج", context: "Quand il est temps de partir" },
...
- **Khassu** (خَاصُّو) = il doit`,
        ...
        quiz: [
          ...
          { question: "Comment dit-on 'je dois partir' ?", options: ["kan-mshi", "bghit n-khrej", "khassni n-khrej", "ma-bghitch n-khrej"], correctIndex: 2 },
...
Note : En darija, on utilise souvent **kan-** (je) et **kay-** (il/elle) pour le présent. La distinction est importante !`,
      ...
      },
      {
        ...
        vocabulary: [
          ...
          { french: "sortir avec des amis", phonetic: "n-khrej m3a s7abi", arabic: "نَخْرُج مَعَ صَحْبِي", notes: "Sortir le soir" },
        ...
        phrases: [
          ...
          { french: "On sort ce weekend ?", phonetic: "n-khrej l-wikend ?", arabic: "نَخْرُج الوِيْكِنْد ؟", context: "Proposer une sortie" },
...
Les pharmacies au Maroc sont identifiables par une croix verte. Beaucoup de médicaments sont vendus sans ordonnance.`,
      ...
      },
      {
        ...
        vocabulary: [
          ...
          { french: "épuisé(e)", phonetic: "m3yan / mdhayek", arabic: "مُعْيَان / مُضَيَّك" },
          { french: "stressé(e)", phonetic: "m3yaqq / stresse", arabic: "مُعَيَّق / سْتْرِسّ", notes: "En darija, on utilise aussi le mot français 'stresse'" },
          { french: "content / heureux", phonetic: "farhan / mabsout", arabic: "فَرْحَان / مَبْسُوط" },
          { french: "triste", phonetic: "z3lan / mhzen", arabic: "زَعْلَان / مَحْزُون" },
        ...
        phrases: [
          { french: "Comment tu vas ? Tu es en forme ?", phonetic: "kifash nta ? nta f-l-hal ?", arabic: "كِفَاش نْتَا ؟ نْتَا فِالحَال ؟", context: "Demander des nouvelles de santé" },
          { french: "Je suis épuisé", phonetic: "ana mdhayek", arabic: "أَنَا مُضَيَّك", context: "Après une longue journée" },
...
- **S7a w-salam** = Santé et paix`,
        ...
        quiz: [
          { question: "Comment dit-on 'je suis content' ?", options: ["ana mrid", "ana farhan", "ana z3lan", "ana mdhayek"], correctIndex: 1 },
          { question: "Que signifie 'allah y-shfak' ?", options: ["Merci", "Au revoir", "Dieu te guérisse", "Dieu te garde"], correctIndex: 2 },
          { question: "Comment dit-on 'en forme' ?", options: ["mrid", "mdhayek", "f-l-hal", "z3lan"], correctIndex: 2 },
          { question: "Que signifie 'mdhayek' ?", options: ["Heureux", "En forme", "Épuisé", "Stressé"], correctIndex: 2 },
    ...
    lessons: [
      {
        ...
        duration: "7 min",
        vocabulary: [
          { french: "professeur", phonetic: "ustadh / m3alem", arabic: "أُسْتَاذ / مُعَلِّم" },
          { french: "médecin", phonetic: "tabib", arabic: "طَبِيبٌ" },
          { french: "ingénieur", phonetic: "muhandis", arabic: "مُهَنْدِس" },
          { french: "commerçant", phonetic: "tojjer", arabic: "تَاجِرٌ", notes: "Le commerçant, vendeur au souk" },
          { french: "artisan", phonetic: "3ammal", arabic: "عَمَّالٌ", notes: "Maroquinier, menuisier..." },
          { french: "paysan / agriculteur", phonetic: "fallah", arabic: "فَلَّاحٌ", notes: "L'agriculture est importante au Maroc" },
          { french: "chauffeur", phonetic: "swwaq", arabic: "سُوَّاقٌ" },
          { french: "policier", phonetic: "bulees / shurti", arabic: "بُولِيس / شُرْطِي" },
          { french: "informaticien", phonetic: "mubarmij", arabic: "مُبَرْمِج", notes: "Développeur / programmeur" },
          { french: "fonctionnaire", phonetic: "mwaddaf", arabic: "مُوَظَّفٌ", notes: "Travaille dans l'administration" },
        ],
        phrases: [
          ...
          { french: "Mon père est commerçant", phonetic: "baba dyali tojjer", arabic: "بَابَا دْيَالِي تَاجِر", context: "Profession d'un parent" },
...
C'est la façon la plus naturelle de demander la profession. Littéralement : « Que fais-tu comme travail ? »`,
        ...
        quiz: [
          ...
          { question: "Comment dit-on 'commerçant' en darija ?", options: ["tabib", "muhandis", "tojjer", "mwaddaf"], correctIndex: 2 },
      ...
      },
      {
        ...
        vocabulary: [
          ...
          { french: "salaire", phonetic: "l-mra7", arabic: "المُرَتَّب / المِرَاح", notes: "Le salaire mensuel" },
        ...
        phrases: [
          ...
          { french: "Le salaire est bon", phonetic: "l-mra7 mzyan", arabic: "المِرَاح مْزْيَان", context: "Parler de la rémunération" },
...
Note : Le darija de bureau au Maroc mélange souvent darija et français.`,
        ...
        quiz: [
          ...
          { question: "Que signifie 'l-mra7' ?", options: ["Congé", "Salaire", "Réunion", "Document"], correctIndex: 1 },
          { question: "Comment dit-on 'ordinateur' en darija ?", options: ["t-lifun", "l-mail", "l-ordinatur", "l-jtima3"], correctIndex: 2 },
          { question: "Comment dit-on 'salaire' en darija ?", options: ["khedma", "mra7", "conge", "wariqa"], correctIndex: 1 },
      ...
      },
      {
        ...
        phrases: [
          ...
          { french: "Le salaire demandé est...", phonetic: "l-mra7 l-matlob...", arabic: "المِرَاح المَطْلُوب...", context: "Négocier le salaire" },
        ],
...
- **Sh7al t-bghi l-mra7 ?** = Combien de salaire souhaitez-vous ?
...
- **Bravou** = bravo / félicitations`,
      ...
      },
      {
        ...
        phrases: [
          ...
          { french: "Cette tajine est délicieuse", phonetic: "had tajin bnina bzzaf", arabic: "هَاد طَاجِين بَنِينَة بْزَاف", context: "Complimenter un plat" },
...
- Préparer sa peau (gommage au savon noir)`,
      ...
      },
      {
        ...
        vocabulary: [
          ...
          { french: "artiste (masc.)", phonetic: "fannan", arabic: "فَنَّان", notes: "Féminin : fannana (فَنَّانَة)" },
    ...
    lessons: [
      {
        ...
        vocabulary: [
          ...
          { french: "authentique / vrai", phonetic: "s-7i / mashi msajjal", arabic: "الصَّحِي / مَاشِي مُسَجَّل" },
...
- **Daba w-la b3d, l-mohim l-jawda** = Maintenant ou après, l'important c'est la qualité`,
      ...
      },
      {
        ...
        vocabulary: [
          ...
          { french: "perdu / égaré", phonetic: "dall / Dawyi", arabic: "دَلّ / ضَاوِي" },
        ...
        phrases: [
          ...
          { french: "J'ai perdu mon sac", phonetic: "dallt l-karita dyali", arabic: "دَلَّلْت الكَارِيتَة دْيَالِي", context: "Objet perdu" },
