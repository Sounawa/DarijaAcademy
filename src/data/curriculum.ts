    ...
    lessons: [
      {
        ...
        vocabulary: [
          ...
          { french: "comment vas-tu (fém) ?", phonetic: "kidayra ?", arabic: "كِيدَايْرَا ؟", notes: "Vrai darija. Masc : ki dayr. Ou 'labas 3lik ?'" },
...
- **S7a w-salam** = Santé et paix`,
        ...
        quiz: [
          ...
          { question: "Que signifie 'mdhayek' (incorrect) ? vrai darija :", options: ["Heureux", "En forme", "Épuisé", "Stressé"], correctIndex: 2, hint: "Le vrai darija est 'm3yan'" },
    ...
    lessons: [
      {
        ...
        vocabulary: [
          ...
          { french: "commerçant", phonetic: "tajer", arabic: "تَاجِرٌ", notes: "Le commerçant, vendeur au souk (forme correcte, pas tojjer)" },
